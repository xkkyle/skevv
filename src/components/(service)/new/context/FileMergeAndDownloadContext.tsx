				...
				<Drawer open={isOpen} onOpenChange={toggle}>
					...
					<DrawerContent>
						<DrawerHeader className="gap-2 p-3 text-left">
							...
							<DrawerDescription className="flex items-center gap-2 p-2 w-fit text-xs text-gray-500 text-start font-medium">
				...
				<Dialog open={isOpen} onOpenChange={toggle}>
					...
					<DialogContent className="max-w-[500px]">
						<DialogHeader>
							...
							<DialogDescription className="flex items-center gap-2 p-2 text-xs text-gray-500 font-medium">
								{step === 'merge' ? <span>⚡️</span> : <span>✅</span>}
								{description}
							</DialogDescription>
						</DialogHeader>
